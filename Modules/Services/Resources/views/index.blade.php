...
<div class="dash-home-cards">
    <div class="row row-cols-xxl-4 row-cols-xl-3 row-cols-md-2 row-cols-1 top-cards">
        <div class="col-md-6 col-lg-4 col-xl-3 mb-25 mb-lg-45">
            <div class="card">
                <a class="card-body p-2" href="{{url('services/booking-req')}}">
                    <p class="cart-title text-white">Bookings</p>
                    <div class="card-results">
                        <h5 class="main-results text-white">{{\Modules\BookService\Entities\Booking::count()}}</h5>
        ...
        <div class="col-md-6 col-lg-4 col-xl-3 mb-25 mb-lg-45">
            <div class="card">
                <a class="card-body p-2" href="{{url('services/custom-req')}}">
                    <p class="cart-title text-white">Custom Requests</p>
                    <div class="card-results">

                        <h5 class="main-results text-white">{{\Modules\Services\Entities\CustomReq::count()}}</h5>
