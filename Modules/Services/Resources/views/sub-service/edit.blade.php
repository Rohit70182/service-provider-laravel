...
<div class="col-md-12">
  ...
  <div class="card">
    ...
    <form method="post" action="{{url('/services/update/sub-service/'.$subService->id)}}" id="subservice-form" enctype="multipart/form-data">
      @csrf
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="form-group">
            <label>Name</label>
            <input type="text" class="form-control" name="name" value='{{ $subService->sub_service_name }}'>
        ...
        <div class="col-lg-12">
          <div class="form-group">
            ...
            <textarea class="form-control" name="desc" rows="6">{{ $subService->description }}</textarea>
          </div>
          <div class="form-group">
