    ...
    <div class="row">
        ...
        <div class="page-head-text">
                <div class="ProfileHader d-flex flex-wrap align-items-center">
                    <h3 class="font_600 font-18 font-md-20 mr-auto pr-20">Show Manager</h3>
                  
                    <a class="btn btn-bg ml-1" href="{{url('/seo/manager/edit')}}/{{$seo->id}}" title="edit"><span class="fa fa-pencil"></span></a>
                   <a class="btn btn-bg ml-1" href="{{url('/seo/manager')}}"> Back</a>
                </div>
