...
<div class="page-head-text">
    <div class="ProfileHader d-flex flex-wrap align-items-center">
      <h3 class="font_600 font-18 font-md-20 mr-auto pr-20">Edit Reason</h3>
    </div>
  </div>
    <div class="card">
    <div class="card-header ">
        <form method="post" action="{{route('updatereason' ,$cancelreasons->id)}}" id="event-add-form" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="row mt-3 align-items-center">
                <div class="col-md-12">
                    <div class="form-group">
                        <label>Reason</label>
                        <textarea class="form-control" id="reason" rows="3" name="reason">{{$cancelreasons->messages}}</textarea>
